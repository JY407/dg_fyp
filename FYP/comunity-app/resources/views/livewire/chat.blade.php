<div>
    ...
    <div class="flex h-[550px] text-sm border around-xl shadow overflow-hidden bg-white">
        <!--Left: user list-->
        ...
        <!--Message Input-->
        <form wire:submit="submit" class="p-4 border-t text-gray-800 flex items-center gap-2">
            <input
